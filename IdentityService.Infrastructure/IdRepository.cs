...
class IdRepository : IIdRepository
{
    ...
    // pagesRouter
    private readonly IdDbContext dbCtx;



    public IdRepository(IdUserManager userManager, RoleManager<Role> roleManager, IdDbContext dbCtx ,  ILogger<IdRepository> logger)
    {
    ...
    public async Task<List<string>> GetRouterList(IList<string> roles)
    {
        try
        {
